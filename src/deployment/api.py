...
class QueryRequest(BaseModel):
    ...
    retrieval_options: Optional[Dict[str, Any]] = Field(None, description="Optional retrieval parameters")
    generation_options: Optional[Dict[str, Any]] = Field(None, description="Optional generation parameters")
...
class EvaluationRequest(BaseModel):
    ...
    test_dataset: List[Dict[str, Any]] = Field(..., description="Test dataset for evaluation")
    metrics: Optional[List[str]] = Field(None, description="List of metrics to evaluate")
...
app = FastAPI(
    ...
    openapi_tags=[
        ...
        {"name": "documents", "description": "Document management operations (add, delete, query)"},
...
async def run_evaluation(task_id: str, test_dataset: List[Dict[str, Any]], metrics: Optional[List[str]] = None):
    """
