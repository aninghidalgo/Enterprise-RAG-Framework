...
class BM25Retriever:
    ...
    def _load_stopwords(self, stopwords_path: Optional[str] = None) -> Set[str]:
        ...
        try:
            ...
            logger.warning(f"Error loading stopwords file: {str(e)}. Using default stopwords.")
            return default_stopwords
    ...
    def save_index(self, index_path: Optional[str] = None) -> None:
        ...
        try:
            ...
            logger.info(f"Saved BM25 index with {self.total_docs} documents to {index_path}")
        except Exception as e:
