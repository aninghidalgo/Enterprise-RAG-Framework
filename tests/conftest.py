...
def sample_documents() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            "metadata": {"source": "test", "title": "Retrieval Methods"},
        },
        {
            "id": "doc3",
        ...
        },
        {
            ...
            "metadata": {"source": "test", "title": "Document Chunking"},
        },
        {
            "id": "doc5",
            ...
            "metadata": {"source": "test", "title": "Reranking"},
        },
    ]
...
def context_augmenter():
    ...
    """
    return ContextAugmenter(max_context_length=2000, citation_format="inline")
    ...
    class MockResponseGenerator(ResponseGenerator):
        def generate(self, query, context, options=None):
            ...
            return {
                ...
                "sources": sources,
                "metadata": {"model": "mock-model", "latency_ms": 100},
            }

    return MockResponseGenerator(model="mock-model", temperature=0.7)
...
def sample_config():
    ...
    """
    return {
        "retrieval_config": {"type": "hybrid", "top_k": 3, "reranker_threshold": 0.7},
        "augmentation_config": {
            "max_context_length": 2000,
            "citation_format": "inline",
        },
        "generation_config": {"model": "mock-model", "temperature": 0.7},
        "evaluation_config": {
            "metrics": [
                "retrieval_precision",
                "answer_relevance",
